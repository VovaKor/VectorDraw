...
public interface IShape extends Modifiable {
	 ...
	 * 
	 */
	void scale(final double prevWidth, final double prevHeight, final EPosition pos, final Rectangle2D bound);
	 ...
	 * 
	 */
	void scaleWithRatio(final double prevWidth, final double prevHeight, final EPosition pos, final Rectangle2D bound);
	 ...
	 */
	IColor getLineColour();

	/**
	 * @param lineColour the lineColour to set.
	 */
	void setLineColour(final IColor lineColour);

	/**
	 * @return the lineStyle.
	 */
	ELineStyle getLineStyle();

	/**
	 * @param lineStyle the lineStyle to set.
	 */
	void setLineStyle(final ELineStyle lineStyle);
	 ...
	 */
	 IColor getFillingCol();

	/**
	 * @param fillingCol the fillingCol to set.
	 */
	void setFillingCol(final IColor fillingCol);

	/**
	 * @return the fillingStyle.
	 */
	 EFillingStyle getFillingStyle();

	/**
	 * @param fillingStyle the fillingStyle to set.
	 */
	void setFillingStyle(final EFillingStyle fillingStyle);

	/**
	 * @return the gradColStart.
	 */
	IColor getGradColStart();

	/**
	 * @param gradColStart the gradColStart to set.
	 */
	void setGradColStart(final IColor gradColStart);

	/**
	 * @return the gradColEnd.
	 */
	IColor getGradColEnd();

	/**
	 * @param gradColEnd the gradColEnd to set.
	 */
	void setGradColEnd(final IColor gradColEnd);
	 ...
	 */
	IColor getHatchingsCol();

	/**
	 * @param hatchingsCol the hatchingsCol to set.
	 */
	void setHatchingsCol(final IColor hatchingsCol);
	 ...
	 */
	IColor getDbleBordCol();

	/**
	 * @param dbleBordCol the dbleBordCol to set.
	 */
	void setDbleBordCol(final IColor dbleBordCol);
	 ...
	 */
	void setShadowCol(final IColor shadowCol);
	 ...
	 * 
	 */
	void setBordersPosition(final EBorderPos position);

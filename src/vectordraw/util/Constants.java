...
public final class Constants {
	...
	public static final String TOKEN_LABELS_DISPLAYED_ALL 	= "all"; 

	/** The text to display when only the X labels must be displayed. */
	public static final String TOKEN_LABELS_DISPLAYED_X 	= "x"; 

	/** The text to display when only the Y labels must be displayed. */
	public static final String TOKEN_LABELS_DISPLAYED_Y 	= "y";

	/** The text to display when no labels must be displayed. */
	public static final String TOKEN_LABELS_DISPLAYED_NONE 	= "none";

	/** The token when the ticks must be fully shown. */
	public static final String TOKEN_TICKS_STYLE_FULL 	= "full";

	/** The token when the ticks only the top of them must be shown. */
	public static final String TOKEN_TICKS_STYLE_TOP	= "top";

	/** The token when the ticks only the bottom of them must be shown. */
	public static final String TOKEN_TICKS_STYLE_BOTTOM = "bottom";

	/** The text to display when the axes have the axes shape. */
	public static final String TOKEN_AXES_STYLE_AXES 	= "axes";

	/** The text to display when the axes have the frame shape. */
	public static final String TOKEN_AXES_STYLE_FRAME 	= "frame";

	/** The text to display when the axes must not be shown. */
	public static final String TOKEN_AXES_STYLE_NONE 	= "none";


	/** The first colour of a gradient by default. */
	public static final IColor DEFAULT_GRADIENT_START_COLOR = ShapeFactory.INST.createColor(0.0, 0.1, 0.95, 1.0);

	/** The second color of a gradient by default. */
	public static final IColor DEFAULT_GRADIENT_END_COLOR   = ShapeFactory.INST.createColor(0.0, 1.0, 1.0, 1.0);
	...
	public static final String TOKEN_FILL_NONE = "none";

	/** The token of the parameters : fillstyle = gradient */
	public static final String TOKEN_FILL_GRADIENT = "gradient";

	/** The token of the parameters : fillstyle = solid */
	public static final String TOKEN_FILL_SOLID = "solid";

	/** The token of the parameters : fillstyle = vlines */
	public static final String TOKEN_FILL_VLINES = "vlines";

	/** The token of the parameters : fillstyle = vlines* */
	public static final String TOKEN_FILL_VLINES_F = "vlines*";

	/** The token of the parameters : fillstyle = hlines */
	public static final String TOKEN_FILL_HLINES = "hlines";

	/** The token of the parameters : fillstyle = hlines* */
	public static final String TOKEN_FILL_HLINES_F = "hlines*";

	/** The token of the parameters : fillstyle = crosshatch */
	public static final String TOKEN_FILL_CROSSHATCH = "crosshatch";

	/** The token of the parameters : fillstyle = crosshatch* */
	public static final String TOKEN_FILL_CROSSHATCH_F = "crosshatch*";

	/** The token of the parameters : cornersize = relative */
	public static final String TOKEN_RELATIVE = "relative";

	/** The token of the parameters : cornersize = absolute */
	public static final String TOKEN_ABSOLUTE = "absolute";

	/** The token of the postscript point unit of length */
	public static final String TOKEN_PS_PT = "pt";

	/** The token of the unit of length : centimeter */
	public static final String TOKEN_CM = "cm";

	/** The token of the unit of length : millimeter */
	public static final String TOKEN_MM = "mm";

	/** The token of the unit of length : inch */
	public static final String TOKEN_INCH = "in";

	/** The style which draw a o and aplus */
	public static final String OPLUS_STYLE      = "oplus"; 

	/** The style which draw a o and a cross */
	public static final String OTIMES_STYLE     = "otimes"; 

	/** The style which draw a plus */
	public static final String PLUS_STYLE       = "+"; 

	/** The style which draw an asterisk */
	public static final String ASTERISK_STYLE   = "asterisk"; 
	...
	public static final String DIAMOND_STYLE    = "diamond"; 

	/** The style which draw a pentagon */
	public static final String PENTAGON_STYLE   = "pentagon"; 

	/** The style which draw a o */
	public static final String O_STYLE          = "o"; 

	/** The style which draw a dot */
	public static final String DOT_STYLE        = "*"; 

	/** The style which draw a cross */
	public static final String X_STYLE          = "x"; 

	/** The style which draw a vertical bar */
	public static final String BAR_STYLE        = "|"; 

	/** The style which draw a full triangle */
	public static final String FTRIANGLE_STYLE  = "triangle*"; 

	/** The style which draw a full square */
	public static final String FSQUARE_STYLE    = "square*"; 

	/** The style which draw a full diamond */
	public static final String FDIAMOND_STYLE   = "diamond*"; 

	/** The style which draw a full pentagon */
	public static final String FPENTAGON_STYLE  = "pentagon*"; 
	...
	public static final IColor DEFAULT_SUB_GRID_COLOR = Colors.GRAY;

	/** The dimensions of the figure are with reference to the inner boundary. */
	public static final String BORDERS_INSIDE = "outer"; 

	/** The dimensions of the figure are with reference to the outter boundary. */
	public static final String BORDERS_OUTSIDE = "inner"; 

	/** The dimensions of the figure are with reference to the middle boundary. */
	public static final String BORDERS_MIDDLE = "middle"; 

	/** The position of the borders by default */
	public static final EBorderPos DEFAULT_BORDERS_POS = EBorderPos.INTO;

	/** The colour of the double boundary of the figure by default */
	public static final IColor DEFAULT_DOUBLE_COLOR = Colors.WHITE;

	/** The colour of the hatching of the figure by default */
	public static final IColor DEFAULT_HATCHING_COLOR = Colors.BLACK;

	/** The colour of the interior of the figure by default */
	public static final IColor DEFAULT_INTERIOR_COLOR = Colors.WHITE;

	/** The colour of the borders of the figure by default */
	public static final IColor DEFAULT_LINE_COLOR = Colors.BLACK;

	/** The colour of the labels by default */
	public static final IColor DEFAULT_LABELGRIDCOLOR = Colors.BLACK;

	/** The colour of the grid by default */
	public static final IColor DEFAULT_GRIDCOLOR = Colors.BLACK;
	...
	public static final String LINE_DOTTED_STYLE = "dotted"; 

	/** The line(s) of the figure are dashed */
	public static final String LINE_DASHED_STYLE = "dashed"; 

	/** The line(s) of the figure have no style */
	public static final String LINE_NONE_STYLE = "none"; 

	/** The line(s) of the figure are solid */
	public static final String LINE_SOLID_STYLE = "solid"; 

	/** The style of the lines by default */
	public static final ELineStyle DEFAULT_LINE_STYLE = ELineStyle.SOLID;
	...
	public static final IColor DEFAULT_BORDER_COLOR = Colors.WHITE;
	...
	public static final IColor DEFAULT_SHADOW_COLOR = Colors.DARKGRAY;

	/** The type of the fill by default */
	public static final EFillingStyle DEFAULT_FILL_STYLE = EFillingStyle.NONE;

	/** The colour of the filling */
	public static final IColor DEFAULT_FILL_COLOR = Colors.WHITE;
	...
	public static final String LARROW_STYLE    = "<"; 
	public static final String RARROW_STYLE    = ">"; 
	public static final String DLARROW_STYLE   = "<<";
	public static final String DRARROW_STYLE   = ">>";
	public static final String BAREND_STYLE   = "|*";
	public static final String BARIN_STYLE     = "|";
	public static final String LSBRACKET_STYLE = "[";
	public static final String RSBRACKET_STYLE = "]";
	public static final String LRBRACKET_STYLE = "(";
	public static final String RRBRACKET_STYLE = ")";
	public static final String CIRCLEEND_STYLE = "o";
	public static final String CIRCLEIN_STYLE  = "oo";
	public static final String DISKEND_STYLE   = "*";
	public static final String DISKIN_STYLE    = "**";
	public static final String ROUNDEND_STYLE  = "c";
	public static final String ROUNDIN_STYLE   = "cc";
	public static final String SQUAREEND_STYLE = "C";
